#ifndef NOISY_LOCALIZATION__NOISY_PLATOON_LOCALIZATION_HPP_
#define NOISY_LOCALIZATION__NOISY_PLATOON_LOCALIZATION_HPP_
...
class NoisyPlatoonLocalization : public rclcpp::Node
{
public:
    ...
    typedef std::shared_ptr<NoisyPlatoonLocalization> SharedPtr;
    typedef std::unique_ptr<NoisyPlatoonLocalization> UniquePtr;

    NoisyPlatoonLocalization();
    NoisyPlatoonLocalization(const rclcpp::NodeOptions& options);
    virtual ~NoisyPlatoonLocalization();
...
#endif  // NOISY_LOCALIZATION__NOISY_PLATOON_LOCALIZATION_HPP_
